...
// Secrets are read from local.properties first, then from environment variables (CI).
...
android {
    namespace = "com.mobees.app"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.mobees.app"
        minSdk = 26
        targetSdk = 35
    ...
    buildTypes {
        release {
            ...
            // Use the release keystore when it is configured, otherwise fall back to the
            // debug keystore so a release APK can always be produced.
